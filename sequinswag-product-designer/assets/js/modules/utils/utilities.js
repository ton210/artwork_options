...
setupGridToggle() {
  ...
  gridButton.className = 'grid-toggle-btn tool-btn';
  ...
  if (toolSection) {
    const toolButtons = toolSection.querySelector('.tool-buttons');
    if (toolButtons) {
      toolButtons.appendChild(gridButton);
    }
  }
...
setupZoomControls() {
  ...
  document.getElementById('zoom-in')?.addEventListener('click', () => updateZoom(currentZoom * 1.2));
  document.getElementById('zoom-out')?.addEventListener('click', () => updateZoom(currentZoom / 1.2));
