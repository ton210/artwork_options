...
class SWPD_Frontend {
    ...
    public function enqueue_scripts() {
        ...
        wp_enqueue_script(
            ...
            ( defined( 'SWPD_SCRIPT_DEBUG' ) && SWPD_SCRIPT_DEBUG )
                ? SWPD_PLUGIN_URL . 'assets/js/enhanced-product-designer-modular.js'
        ...
        if ( defined( 'SWPD_SCRIPT_DEBUG' ) && SWPD_SCRIPT_DEBUG ) {
            add_filter( 'script_loader_tag', function( $tag, $handle, $src ) {
                if ( 'swpd-enhanced-product-designer' === $handle ) {
                    ...
                    if ( strpos( $src, 'enhanced-product-designer-modular.js' ) !== false ) {
    ...
    public function display_cart_item_thumbnail( $thumbnail, $cart_item, $cart_item_key ) {
        if ( isset( $cart_item['custom_design_preview'] ) && ! empty( $cart_item['custom_design_preview'] ) ) {
            ...
            $thumbnail = sprintf(
                '<img src="%s" alt="%s" class="attachment-shop_thumbnail size-shop_thumbnail swpd-custom-design-thumbnail" />',
                esc_url( $preview_url ),
