...
class Vendor_Order_Manager {
    ...
    private function includes() {
        ...
        // Shopify API fix and diagnostics
        if ( file_exists( VSS_PLUGIN_DIR . 'includes/class-vss-shopify-fix.php' ) ) {
            require_once VSS_PLUGIN_DIR . 'includes/class-vss-shopify-fix.php';
        }
        
        // Product admin management
        require_once VSS_PLUGIN_DIR . 'includes/class-vss-product-admin.php';
        require_once VSS_PLUGIN_DIR . 'includes/class-vss-store-integration.php';
        
        
        // Slack integration
        if ( file_exists( VSS_PLUGIN_DIR . 'includes/class-vss-slack-integration.php' ) ) {
            require_once VSS_PLUGIN_DIR . 'includes/class-vss-slack-integration.php';
        }
    }
    ...
    private function init_components() {
        ...
        // Initialize product admin management
        VSS_Product_Admin::init();
        VSS_Store_Integration::init();
        
        // Initialize Slack integration
        if ( class_exists( 'VSS_Slack_Integration' ) ) {
            VSS_Slack_Integration::init();
        }
    }
    ...
    public function activate() {
        ...
        // Create product upload tables
        if ( method_exists( 'VSS_Vendor', 'create_product_tables' ) ) {
            VSS_Vendor::create_product_tables();
        }
        
        // Create store integration tables
        if ( class_exists( 'VSS_Store_Integration' ) ) {
            VSS_Store_Integration::create_integration_tables();
        }
