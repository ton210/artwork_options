...
trait VSS_Vendor_Shortcodes {
        ...
        private static function render_vendor_navigation( $current_action ) {
            ...
            <nav class="vss-vendor-navigation">
                <div class="vss-vendor-navigation-inner">
                    ...
                    <a href="<?php echo esc_url( add_query_arg( 'vss_action', 'upload_products', get_permalink() ) ); ?>"
                       class="<?php echo $current_action === 'upload_products' ? 'active' : ''; ?> vss-upload-products-nav">
                        <span class="dashicons dashicons-upload"></span>
                        <?php esc_html_e( 'Upload Products', 'vss' ); ?>
                        <span class="vss-nav-badge"><?php esc_html_e( 'NEW', 'vss' ); ?></span>
                    </a>
         ...
         */
                /**
         * Render vendor application form by calling the correct function
         */
        public static function render_vendor_application_shortcode() {
            // This will now call the function for the longer form
