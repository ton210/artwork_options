...
trait VSS_Vendor_Analytics {
    ...
    public static function get_vendor_analytics( $vendor_id, $date_range = 'last_30_days' ) {
        ...
        if ($use_sample) {
            return self::get_sample_analytics_data();
        }
    ...
    private static function get_overview_stats( $vendor_id, $date_range ) {
        ...
        // Get orders for current period - HPOS Compatible
        ...
        if (WP_DEBUG) {
            error_log("VSS Analytics Debug - Vendor ID: $vendor_id, Orders found: " . count($current_orders));
        }

        // If no orders found, generate sample data for demonstration
        if (empty($current_orders) && get_option('vss_use_sample_data', false)) {
            return self::get_sample_overview_stats();
        }
        ...
        // Get previous period for comparison - HPOS Compatible
    ...
    /**
     * Get sample overview statistics for demonstration
     */
    private static function get_sample_overview_stats() {
        return [
            'total_orders' => 47,
            'total_revenue' => 12847.50,
            'total_costs' => 8234.75,
            'total_profit' => 4612.75,
            'average_order_value' => 273.35,
            'orders_growth' => 18.5,
            'revenue_growth' => 22.3,
    ...
    /**
     * Get complete sample analytics data for demonstration
     */
    private static function get_sample_analytics_data() {
        return [
            'overview' => [
                'total_orders' => 47,
                'total_revenue' => 12847.50,
            ...
            'sales' => [
                'by_status' => [
                    'completed' => ['count' => 32, 'revenue' => 8750.40],
                    'processing' => ['count' => 8, 'revenue' => 2184.60],
                    'shipped' => ['count' => 5, 'revenue' => 1365.75],
                    'pending' => ['count' => 2, 'revenue' => 546.75],
                ],
                'by_day' => [
                    '2024-01-15' => ['orders' => 3, 'revenue' => 824.50],
                    '2024-01-16' => ['orders' => 5, 'revenue' => 1245.75],
                    '2024-01-17' => ['orders' => 2, 'revenue' => 456.25],
                    '2024-01-18' => ['orders' => 7, 'revenue' => 1876.80],
                    '2024-01-19' => ['orders' => 4, 'revenue' => 987.60],
                ],
                'peak_hours' => [
                    '09:00' => 12, '10:00' => 15, '11:00' => 18, '12:00' => 8,
                    '13:00' => 6, '14:00' => 22, '15:00' => 19, '16:00' => 14,
                    '17:00' => 9, '18:00' => 5, '19:00' => 3, '20:00' => 2
                ],
            ],
            'performance' => [
                'quality_score' => 92.5,
                ...
                'mockup_approval_rate' => 89.5,
                'production_approval_rate' => 95.8,
                'late_orders_percentage' => 5.3,
            ],
            'customers' => [
                'total_customers' => 34,
                'new_customers' => 12,
                'returning_customers' => 22,
                'customer_lifetime_value' => 378.45,
                'top_customers' => [
            ...
            'products' => [
                ...
                'total_items_sold' => 89,
                'top_products' => [
                    101 => ['name' => 'Custom T-Shirt', 'quantity' => 24, 'revenue' => 3456.00],
                    102 => ['name' => 'Logo Design', 'quantity' => 18, 'revenue' => 2745.50],
                    103 => ['name' => 'Business Cards', 'quantity' => 15, 'revenue' => 1875.75],
                    104 => ['name' => 'Website Banner', 'quantity' => 12, 'revenue' => 1560.25],
                    105 => ['name' => 'Flyer Design', 'quantity' => 10, 'revenue' => 1245.80],
                ],
                'product_categories' => [
                    'Apparel' => 35,
                    'Graphics' => 28,
