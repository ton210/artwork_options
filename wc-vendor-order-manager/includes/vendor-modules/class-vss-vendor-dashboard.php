...
trait VSS_Vendor_Dashboard {
    ...
    use VSS_Vendor_Analytics;


        /**
         * Render vendor dashboard
         */
        public static function render_vendor_dashboard() {
                ...
                <div class="vss-page-header">
                    <div class="vss-header-row">
                        <div class="vss-header-left">
                            ...
                            <?php if ( get_option('vss_use_sample_data', true) ) : ?>
                                <div style="background: #e7f3ff; border-left: 4px solid #2196f3; padding: 8px 12px; margin-top: 10px; border-radius: 4px;">
                                    <small style="color: #1976d2;">
                                        <strong>📊 Demo Mode:</strong> Showing sample data for demonstration. 
                                        Real data will appear when you have actual orders.
                                    </small>
                                </div>
                            <?php endif; ?>
                        </div>
        ...
        public static function render_dashboard_pending_tasks_widget() {
            ...
            // Orders needing ship date - HPOS Compatible
            $no_ship_date = wc_get_orders( [
                'status' => 'processing',
                '_vss_vendor_user_id' => $vendor_id,
                '_vss_estimated_ship_date' => ['compare' => 'NOT EXISTS'],
                'return' => 'ids',
                'limit' => -1,
            ] );
            ...
            // Orders needing mockup - Temporarily disabled for HPOS compatibility
            // TODO: Reimplement with proper HPOS support
            $no_mockup = [];
